...
Before diving into the OMLP (*pun intended*) we must first understand how options contracts are structured within the options market. Please visit the ["Options - For Starters"](/options-for-starters) guide for futher details on options markets basics.
...
![trader_vs_trader](/trader_vs_trader.png)
